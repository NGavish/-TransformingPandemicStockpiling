function Figure1_VerySevere_Revised
...
nexttile
gammaI=1/2; gammaH=1/4; pHospitalization=0.12; 
...
% Save (Optional)
printGraph('./graphs/Figure1_VerySevere_Revised');
...
function plotPanelB(pHospitalization, duration, clinicalAttackRate, gammaI, gammaH, N)
    ...
    % Formatting
    title('Dynamic Model (CDC Very Severe)', 'FontSize', 12);
